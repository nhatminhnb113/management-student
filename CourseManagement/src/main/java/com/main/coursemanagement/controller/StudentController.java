...
public class StudentController {
    ...
    @PostMapping("/listByClassroom")
    public ResponseEntity<?> listByClassroom (@RequestBody Classroom classroom) {
        return new ResponseEntity<>(studentService.listByClassroom(classroom),HttpStatus.OK);
    }
